...
// n. must be 8 or larger. Larger values produce bigger smears.
...
function smear(c, n, x, y, w, h) {
    ...
    // store transformed pixel values. If we needed an output buffer,
    // we could create a new ImageData with the same dimensions like this:
    ...
    // This is the byte array that holds the raw pixel data, left-to-tight and 
    ...
    // 1/nth of its own values plus m/nths of the previous pixel's value
    let m = n - 1;
...
// Test smear function
smear(c, 10, 20, 40, 745, 200); // Smear a rectangle of pixels on the canvas

//smear(c, 10, 0, 0, 800, 200); // Smear the entire canvas area
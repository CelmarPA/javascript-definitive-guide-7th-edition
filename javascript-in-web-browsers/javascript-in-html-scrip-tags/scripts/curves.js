...
c.stroke(); // Stroke is outline.

// Now draw an ellipse in the same way
c.beginPath(); // Start a new path not connected to the circle
c.ellipse(200, 100, 50, 35, rads(15), // Center, radii, and rotation
          0, rads(360), false); // Start angle, end angle, direction

// Draw a wedge. Angles are measured clockwise drom the positive x axis.
...
c.arc(325, 100, 50, // Circle center and radius
      rads(-60), rads(0), true); // Start at angle -60 and go to angle 0, counterclockwise
...
// Finally, fill curves and stroke their outlines.
c.fill();
c.stroke();